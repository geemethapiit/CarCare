...
@section('content')
    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="form-elements">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{ route('branches.create') }}">New Branch</a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="form-elements2">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="{{ route('sub-services.index') }}">View Sub-Services</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{ route('sub-services.create') }}">New Sub-Service</a></li>
                            </ul>
                        </div>
                    </li>
            ...
            <!-- partial -->
            <div class="container">
                <h1 class="my-4">Add New Sub-Service</h1>
                ...
                <form action="{{ route('sub-services.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="SubServiceId" class="form-label">Sub-Service ID</label>
                        <input type="text" class="form-control" id="SubServiceId" name="SubServiceId" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="ServiceTypeId" name="ServiceTypeId" class="form-select" required>
