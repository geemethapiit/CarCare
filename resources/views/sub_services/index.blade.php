...
@section('content')
    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <!-- partial -->
            <div class="container">
                <h1 class="my-4">Sub-Services List</h1>
                ...
                <table class="table table-striped">
                    ...
                    @forelse ($subServices as $subService)
                        <tr>
                            ...
                            <td>{{ $subService->service->ServiceTypeName }}</td> <!-- Assuming relationship is set up -->
                            <td>
                                <a href="{{ route('sub-services.edit', $subService->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                <form action="{{ route('sub-services.destroy', $subService->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center">No sub-services found.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
