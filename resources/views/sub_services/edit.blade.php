            ...
            <span class="input-group-text" id="search">
              <i class="fas fa-search"></i>
                    ...
                    <div class="container-fluid page-body-wrapper">
                        ...
                        <!-- partial -->
                        <div class="container">
                            <h1 class="my-4">Edit Sub-Service</h1>
                            ...
                            <form action="{{ route('sub-services.update', $subService->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="SubServiceId" name="SubServiceId" value="{{ $subService->SubServiceId }}" required>
                                </div>
                                <div class="mb-3">
                                    <label for="SubServiceName" class="form-label">Sub-Service Name</label>
                                    <input type="text" class="form-control" id="SubServiceName" name="SubServiceName" value="{{ $subService->SubServiceName }}" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select id="ServiceTypeId" name="ServiceTypeId" class="form-select" required>
                                        @foreach ($services as $service)
                                            <option value="{{ $service->ServiceTypeId }}" {{ $subService->ServiceTypeId == $service->ServiceTypeId ? 'selected' : '' }}>
