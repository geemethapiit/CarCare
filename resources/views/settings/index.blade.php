...
@section('content')
    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <!-- partial -->
            <div class="container">
                <h1 class="my-4">Appointment Settings</h1>
                ...
                <form action="{{ route('settings.update') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="max_appointments" class="form-label">Maximum Appointments per Time Slot</label>
                        <input type="number" class="form-control" id="max_appointments" name="max_appointments" value="{{ $setting->max_appointments ?? 4 }}" required>
                    </div>
