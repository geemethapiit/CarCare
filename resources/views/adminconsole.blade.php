                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="form-elements2">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="{{ route('sub-services.index') }}">View Branches</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{ route('sub-services.create') }}">New Branches</a></li>
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Welcome <span class="text-black fw-bold">{{ $name }}</span></h3>
                                    ...
                                    <div class="justify-content-end d-flex">
                                        <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                                            <button class="btn btn-sm btn-light bg-white dropdown-toggle" type="button" id="dropdownMenuDate2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                <i class="mdi mdi-calendar"></i> <span id="current-date"></span> </button>
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card tale-bg">
                                <div class="card-people mt-auto">
                                    <img src="/images/workers-of-car-service-center-painting-illustration-download-in-svg-png-gif-file-formats--teamwork-skilled-paint-team-pack-automobile-illustrations-2451635.png" alt="people">
