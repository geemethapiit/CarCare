...
@section('content')
    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="container">
                <h1 class="my-4">Edit Branch</h1>

                <form action="{{ route('branches.update', $branch->BranchID) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="BranchID">Branch ID</label>
                        <input type="text" class="form-control" id="BranchID" name="BranchID" value="{{ $branch->BranchID }}" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('telephone') is-invalid @enderror" id="telephone" name="telephone" value="{{ old('telephone', $branch->telephone) }}">
                        @error('telephone')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
