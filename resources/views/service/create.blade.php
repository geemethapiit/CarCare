...
@section('content')
    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <!-- partial -->
            <div class="container">
                <h1 class="my-4">Add New Service</h1>
                ...
                <form action="{{ route('service.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="ServiceTypeId" name="ServiceTypeId" required>
                    </div>
                    <div class="mb-3">
                        <label for="ServiceTypeName" class="form-label">Service Name</label>
                        <input type="text" class="form-control" id="ServiceTypeName" name="ServiceTypeName" required>
                    </div>
