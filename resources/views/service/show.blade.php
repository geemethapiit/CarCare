...
@section('content')
    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <!-- partial -->
            <div class="container">
                <h1 class="my-4">Service Details</h1>

                <div class="mb-3">
                    <label for="ServiceTypeId" class="form-label">Service ID</label>
                    <input type="text" class="form-control" id="ServiceTypeId" name="ServiceTypeId" value="{{ $services->ServiceTypeId }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="ServiceTypeName" class="form-label">Service Name</label>
                    <input type="text" class="form-control" id="ServiceTypeName" name="ServiceTypeName" value="{{ $services->ServiceTypeName }}" readonly>
                </div>
